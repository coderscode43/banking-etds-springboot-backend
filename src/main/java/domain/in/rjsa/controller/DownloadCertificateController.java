...
//XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX Schedular for Create Zip File XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//	@Scheduled(fixedRate = 360000) // 86400000 //3600000
...
//					String q = n[2];
//					String c = n[3];
//					Long branchCode = Long.valueOf(n[4].split(Pattern.quote("."), -1)[0]);
//					String path = StaticData.CertificatePath;
//					String destFilePath = path + "download/" + fy + "//" + q + "//" + c + "//" + s.replace(".zip", "");
//					if (c.equalsIgnoreCase("Form16")) {
//						List<String> listPan = mergePan(r24qService.getPanList(q, fy, branchCode), null);
//						if (!listPan.isEmpty()) {
//							List<String> filesToSend = getAllCertificates(listPan, fy, ay, q, c, t);
//							logger.info(filesToSend.toString());
//							if (filesToSend.isEmpty()) {
//								listPan.remove(0);
//								logger.info("No Certificate Found");
//							} else {
//								pack(filesToSend, destFilePath);
//								logger.info("Zip Created Successfully");
//							}
//						}
//					} else if (c.equalsIgnoreCase("Form16A")) {
//						List<String> listPan = mergePan(r26qService.getPanList(q, fy, branchCode),
//								r27qService.getPanList(q, fy, branchCode));
//						if (!listPan.isEmpty()) {
//							List<String> filesToSend = getAllCertificates(listPan, fy, ay, q, c, t);
...
//							}
//						}
//					} else if (c.equalsIgnoreCase("Form27D")) {
//						List<String> listPan = mergePan(r27eqService.getPanList(q, fy, branchCode), null);
//						if (!listPan.isEmpty()) {
//							List<String> filesToSend = getAllCertificates(listPan, fy, ay, q, c, t);
//							System.out.println(filesToSend);
//							if (filesToSend.isEmpty()) {
