...
public class Regular26QDeducteeController
	...
	@Autowired
	Regular26QDeducteeUpdateRequestDetailService uService;
	@Autowired
	...
	public void create(LinkedHashMap<String, Object> entity) {
		...
		uService.save(gson.fromJson(jsonElement, Regular26QDeducteeUpdateRequestDetail.class));
	...
	public void update(LinkedHashMap<String, Object> entity) {
		...
		if (listReqDoc.isEmpty() || listReqDoc == null) {
			...
			for (Regular26QDeducteeUpdateRequestDetail doc : listReqDoc) {
