...
public class Regular24Q4DeducteeDaoImpl  extends AbstractNewDao<Long, Regular24Q4Deductee> implements Regular24Q4DeducteeDao{
	...
	public List< Regular24Q4Deductee> search(HashMap entity, Long clientId) {
		...
		if (entity.get("toDate") != null) {
			criteria.add(
					Restrictions.le("dateOfPayment", Date.from(ZonedDateTime.parse((String) entity.get("toDate")).toInstant())));
		}
		...
		return (List< Regular24Q4Deductee>) criteria.list();
	}
}
