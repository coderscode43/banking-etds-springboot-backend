...
//	
//	@SuppressWarnings("unchecked")
//	public List<Regular24QSalary> searchExcel(HashMap entity) {
//		Criteria criteria = createEntityCriteria();
//		criteria.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY);// To avoid duplicates.
//		Map<String, Object> propertyNameValues = new HashMap<String, Object>();
//		//propertyNameValues.put("clientId", clientId);
...
public class Regular24QSalaryDaoImpl extends AbstractDaoFY<Long, Regular24QSalary> implements Regular24QSalaryDao {
    ...
    public List<Regular24QSalary> search(HashMap entity, int pageNo, int noOfResult) {
        ...
        CriteriaQuery<Regular24QSalary> cq = cb.createQuery(Regular24QSalary.class);
        Root<Regular24QSalary> root = cq.from(Regular24QSalary.class);

        Predicate predicate = buildPredicates(cb, root, entity);
    ...
    /**
     * Build predicates dynamically based on the entity map.
     */
    private Predicate buildPredicates(CriteriaBuilder cb, Root<Regular24QSalary> root, HashMap<String, Object> entity) {
        ...
        for (Map.Entry<String, Object> entry : entity.entrySet()) {
            ...
            // Handle numeric fields automatically
            if (isNumericField(key)) {
                try {
                    Double numericValue = parseDouble(value);
                    predicate = cb.and(predicate, cb.equal(root.get(key), numericValue));
    ...
    private boolean isNumericField(String key) {
        return switch (key) {
            case "grossSalaryAsPerProvision", "profitInSalary", "taxableSalaryFromCurrentEmp",
                 "reportedSalaryFromOtherEmp", "totalAmountOfSalary", "commutedValueOfPension",
                 "leaveEncashmentSalary", "anyOtherExemptionus10", "totalAmountOfExemption",
                 "pTax", "standardDeduction", "totalDeductionUnderSection16", "incomeFromSalary",
                 "incomeFromHouseProperty", "incomeFromOtherSources", "grossTotalIncome",
                 "deductionUs80C", "deductionUs80CCC", "deductionUs80CCD1", "deductionUs80C80CCC80CCD1",
                 "deductionUs80CCD1B", "deductionUs80CCD2", "deductionUs80D", "deductionUs80G",
                 "deductionUs80TTA", "amountDeductible80ccg", "anyOtherDeduction", "totalDeductionUnderChapterVIA",
                 "totalTaxableIncome", "incomeTaxOnTotalIncome", "rebateUs87A", "surcharge",
                 "educationCess", "incomeTaxReliefUs89", "netIncomeTaxPayable", "tdsFromCurrentEmployer",
                 "reportedTdsFromPreviousEmployer", "totalTds", "shortfallInTaxDeduction",
                 "countOfPanOfLandlord", "contributionPaidByTrustees" -> true;
            default -> false;
        };
    }

    /**
     * Safely parse numeric values from Object.
     */
