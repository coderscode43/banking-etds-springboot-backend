...
public class Regular26QDeducteeUpdateRequestDetailDaoImpl
	...
	public List<Regular26QDeducteeUpdateRequestDetail> search(HashMap entity) {
		...
		if (entity.get("toDate") != null) {
			criteria.add(Restrictions.le("paymentDate",
		...
		return (List<Regular26QDeducteeUpdateRequestDetail>) criteria.list();
	}

	@Override
	@SuppressWarnings("unchecked")
	public List<Regular26QDeducteeUpdateRequestDetail> findall(HashMap<String, Object> constrains, int pageNo,
			int noOfResult) {
		Criteria criteria = createEntityCriteria();
		criteria.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY);// To avoid duplicates.
