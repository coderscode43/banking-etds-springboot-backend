...
@Repository("regular27EQDeducteeDefualtDao")
public class Regular27EQDeducteeDefualtDaoImpl extends AbstractDaoFY<Long, Regular27EQDeducteeDefualt> implements Regular27EQDeducteeDefualtDao {


	@SuppressWarnings("unchecked")
	public List<Regular27EQDeducteeDefualt> search(HashMap entity) {
		...
		return (List<Regular27EQDeducteeDefualt>) criteria.list();
