...
public class Regular27QDeducteeDaoImpl extends AbstractDaoFY<Long, Regular27QDeductee> implements Regular27QDeducteeDao {
	 ...
	 * @Override
	 * 
	 * @SuppressWarnings("unchecked") public List<Regular27QDeductee>
	 ...
	 * (List<Regular27QDeductee>) criteria.list();
	 * 
	 * }
	 */
