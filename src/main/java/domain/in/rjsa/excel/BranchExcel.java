...
//				row3.getCell(i).setCellStyle(style2);
			...
			row1.getCell(1).setCellValue("BRANCH");
...
//			row4.getCell(5).setCellValue("");
	...
	private void studentDetailExcel(SXSSFWorkbook wbs2) {
		try {
			...
			sheet.setColumnWidth(2, 5000);
			row0.getCell(2).setCellValue("RO Code");
			sheet.setColumnWidth(3, 4000);
			row0.getCell(3).setCellValue("Branch Name");
			sheet.setColumnWidth(4, 4000);
			row0.getCell(4).setCellValue("Branch Email");
			sheet.setColumnWidth(5, 4000);
			row0.getCell(5).setCellValue("Branch Contact No");
			sheet.setColumnWidth(6, 4000);
			row0.getCell(6).setCellValue("Branch Address");
	...
	public static void main(String[] args) {
		BranchExcel cde = new BranchExcel();
		cde.initialise("C:\\Users\\RJSA-15022021-03\\Desktop\\Branch.xlsx");
		cde.close();
	}
