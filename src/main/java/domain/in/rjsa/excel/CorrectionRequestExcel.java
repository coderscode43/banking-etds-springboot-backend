...
public class CorrectionRequestExcel{
...
//				row3.getCell(i).setCellStyle(style2);
			...
			row1.getCell(1).setCellValue("CorrectionRequest");
...
//		stylematchblank();
	...
	private void studentDetailExcel(SXSSFWorkbook wbs2) {
		try {
			int part = 1;
			initializeSheet("correctionRequest-1");
	...
	public static void main(String[] args) {
		CorrectionRequestExcel cde = new CorrectionRequestExcel();
		cde.initialise("C:\\Users\\RJSA-15022021-03\\Desktop\\CorrectionRequest.xlsx");
		cde.close();
	}
