...
public class DeductorDetailsExcel {
...
//				row3.getCell(i).setCellStyle(style2);
			...
			row1.getCell(1).setCellValue("Deductor Details");
...
//			row4.getCell(5).setCellValue("");
	...
	private void studentDetailExcel(SXSSFWorkbook wbs2) {
		try {
			Sheet sheet = wbs.createSheet("DeductorDetails");
			...
			row0.getCell(1).setCellValue("TAN");
			sheet.setColumnWidth(2, 5000);
			row0.getCell(2).setCellValue("State");
			sheet.setColumnWidth(3, 4000);
			row0.getCell(3).setCellValue("City");
	...
	public static void main(String[] args) {
		DeductorDetailsExcel cde = new DeductorDetailsExcel();
		cde.initialise("C:\\Users\\RJSA-15022021-03\\Desktop\\DeductorDetails.xlsx");
		cde.close();
	}
