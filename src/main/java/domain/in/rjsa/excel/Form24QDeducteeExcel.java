...
//				row3.getCell(i).setCellStyle(style2);
			...
			row1.getCell(1).setCellValue("FORM 24Q DEDUCTEE");
...
//		stylematchblank();
		try {
			...
			row0.getCell(20).setCellValue("certificate No.");
			sheet.setColumnWidth(21, 4000);
			row0.getCell(21).setCellValue("Remarks Reason");
			sheet.setColumnWidth(22, 4000);
			row0.getCell(22).setCellValue("Pan Ref. No.");
			sheet.setColumnWidth(23, 4000);
			row0.getCell(23).setCellValue("Error Description");
			sheet.setColumnWidth(24, 4000);
			row0.getCell(24).setCellValue("Warning Description");
			sheet.setColumnWidth(25, 4000);
			row0.getCell(25).setCellValue("Short Deduction");
			sheet.setColumnWidth(26, 4000);
			row0.getCell(26).setCellValue("Interest on Short Deduction");
			sheet.setColumnWidth(27, 4000);
			row0.getCell(27).setCellValue("Interest on Late Payment");
			sheet.setColumnWidth(28, 4000);
			row0.getCell(28).setCellValue("Interest on Late Deduction");
			sheet.setColumnWidth(29, 4000);
			row0.getCell(29).setCellValue("Comments");
			sheet.setColumnWidth(30, 4000);
			row0.getCell(30).setCellValue("Status");
	...
	public static void main(String[] args) {
		Form24QDeducteeExcel cde = new Form24QDeducteeExcel();
		cde.initialise("C:\\Users\\RJSA-15022021-03\\Desktop\\Form24QDeductee.xlsx");
		cde.close();
	}
