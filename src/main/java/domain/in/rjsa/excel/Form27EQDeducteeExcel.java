...
public class Form27EQDeducteeExcel {
...
//				row3.getCell(i).setCellStyle(style2);
			...
			row1.getCell(1).setCellValue("FORM 27EQ DEDUCTEE");
...
//			row4.getCell(5).setCellValue("");
	...
	private void studentDetailExcel(SXSSFWorkbook wbs2) {
		try {
			Sheet sheet = wbs.createSheet("form27EQDeductee");
			...
			row0.getCell(5).setCellValue("Vend/Cust Id");
			...
			row0.getCell(9).setCellValue("Party Ref. No.");
			sheet.setColumnWidth(10, 4000);
			row0.getCell(10).setCellValue("Party Code");
			sheet.setColumnWidth(11, 4000);
			row0.getCell(11).setCellValue("Pan of the Party");
			sheet.setColumnWidth(12, 4000);
			row0.getCell(12).setCellValue("Name of the Party");
			sheet.setColumnWidth(13, 4000);
			row0.getCell(13).setCellValue("Amount Receipt / Debited");
			sheet.setColumnWidth(14, 4000);
			row0.getCell(14).setCellValue("Date Of Received / Debited");
			sheet.setColumnWidth(15, 4000);
			row0.getCell(15).setCellValue("TCS");
			sheet.setColumnWidth(16, 4000);
			row0.getCell(16).setCellValue("Surcharge");
			sheet.setColumnWidth(17, 4000);
			row0.getCell(17).setCellValue("Education Cess");
			sheet.setColumnWidth(18, 4000);
			row0.getCell(18).setCellValue("Total Tax Collection");
			sheet.setColumnWidth(19, 4000);
			row0.getCell(19).setCellValue("Total Tax Deposited");
			sheet.setColumnWidth(20, 4000);
			row0.getCell(20).setCellValue("Date Of Collection");
			sheet.setColumnWidth(21, 4000);
			row0.getCell(21).setCellValue("Total Value Of Purchase");
			sheet.setColumnWidth(22, 4000);
			row0.getCell(22).setCellValue("Rate At Which Tax Deducted");
			sheet.setColumnWidth(23, 4000);
			row0.getCell(23).setCellValue("Reason For Non-Collection");
			sheet.setColumnWidth(24, 4000);
			row0.getCell(24).setCellValue("Section/Collection Code");
			sheet.setColumnWidth(25, 4000);
			row0.getCell(25).setCellValue("Certificate Number");
			sheet.setColumnWidth(26, 4000);
			row0.getCell(26).setCellValue("Deductee is Non-Resident");
			sheet.setColumnWidth(27, 4000);
			row0.getCell(27).setCellValue("Permanent Establishment");
			sheet.setColumnWidth(28, 4000);
			row0.getCell(28).setCellValue("Reason For Non-Collection F or G");
			sheet.setColumnWidth(29, 4000);
			row0.getCell(29).setCellValue("if Answer is 681A is YES then Challan Number");
			sheet.setColumnWidth(30, 4000);
			row0.getCell(30).setCellValue("if Answer is 681A is YES then Date of payment of TDS to Central Government");
			sheet.setColumnWidth(31, 4000);
			row0.getCell(31).setCellValue("Error Description");
			sheet.setColumnWidth(32, 4000);
			row0.getCell(32).setCellValue("Warning Description");
			sheet.setColumnWidth(33, 4000);
			row0.getCell(33).setCellValue("Short Deduction");
			sheet.setColumnWidth(34, 4000);
			row0.getCell(34).setCellValue("Interest on Short Deduction");
			sheet.setColumnWidth(35, 4000);
			row0.getCell(35).setCellValue("Interest on Late Payment");
			sheet.setColumnWidth(36, 4000);
			row0.getCell(36).setCellValue("Interest on Late Deduction");
			sheet.setColumnWidth(37, 4000);
			row0.getCell(37).setCellValue("TAN");
			sheet.setColumnWidth(38, 4000);
			row0.getCell(38).setCellValue("Comments");
			sheet.setColumnWidth(39, 4000);
			row0.getCell(39).setCellValue("Status");
	...
	public static void main(String[] args) {
		Form27EQDeducteeExcel cde = new Form27EQDeducteeExcel();
		cde.initialise("C:\\Users\\RJSA-15022021-03\\Desktop\\Form27EQDeductee.xlsx");
		cde.close();
	}
