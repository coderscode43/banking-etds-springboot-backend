...
public class Form27QDeducteeExcel {
...
//				row3.getCell(i).setCellStyle(style2);
			...
			row1.getCell(1).setCellValue("FORM 27Q DEDUCTEE");
...
//		stylematchblank();
		try {
			...
			row0.getCell(5).setCellValue("Challan Heading");
			sheet.setColumnWidth(6, 4000);
			row0.getCell(6).setCellValue("PAN");
			sheet.setColumnWidth(7, 4000);
			row0.getCell(7).setCellValue("Name");
			sheet.setColumnWidth(8, 4000);
			row0.getCell(8).setCellValue("Section Code");
			sheet.setColumnWidth(9, 4000);
			row0.getCell(9).setCellValue("TAN");
			sheet.setColumnWidth(10, 4000);
			row0.getCell(10).setCellValue("Unique Ref No");
			sheet.setColumnWidth(11, 4000);
			row0.getCell(11).setCellValue("Account Number");
			sheet.setColumnWidth(12, 4000);
			row0.getCell(12).setCellValue("Date Of Payment");
			sheet.setColumnWidth(13, 4000);
			row0.getCell(13).setCellValue("Date Of Deduction");
			sheet.setColumnWidth(14, 4000);
			row0.getCell(14).setCellValue("Amount Paid");
			sheet.setColumnWidth(15, 4000);
			row0.getCell(15).setCellValue("TDS");
			sheet.setColumnWidth(16, 4000);
			row0.getCell(16).setCellValue("Surcharge");
			sheet.setColumnWidth(17, 4000);
			row0.getCell(17).setCellValue("Education Cess");
			sheet.setColumnWidth(18, 4000);
			row0.getCell(18).setCellValue("Total Tax Deducted");
			sheet.setColumnWidth(19, 4000);
			row0.getCell(19).setCellValue("Total Tax Deposited");
			sheet.setColumnWidth(20, 4000);
			row0.getCell(20).setCellValue("Certificate Number");
			sheet.setColumnWidth(21, 4000);
			row0.getCell(21).setCellValue("Remark Reason");
			sheet.setColumnWidth(22, 4000);
			row0.getCell(22).setCellValue("Deductee Code");
			sheet.setColumnWidth(23, 4000);
			row0.getCell(23).setCellValue("Rate at which tax Deducted");
			sheet.setColumnWidth(24, 4000);
			row0.getCell(24).setCellValue("Cash Withdrawl (194N)");
			sheet.setColumnWidth(25, 4000);
			row0.getCell(25).setCellValue("Cash Withdrawl 194N(20L to 1Cr)");
			sheet.setColumnWidth(26, 4000);
			row0.getCell(26).setCellValue("Cash Withdrawl 194N(>1Cr)");
			sheet.setColumnWidth(27, 4000);
			row0.getCell(27).setCellValue("Grossing Up Indicator");	
			sheet.setColumnWidth(28, 4000);
			row0.getCell(28).setCellValue("TDS Rate As Per IT Acts");
			sheet.setColumnWidth(29, 4000);
			row0.getCell(29).setCellValue("Nature Of Remittance");
			sheet.setColumnWidth(30, 4000);
			row0.getCell(30).setCellValue("Unique Acknowledge No)");
			sheet.setColumnWidth(31, 4000);
			row0.getCell(31).setCellValue("Country of Residence Of the Deductee");
			sheet.setColumnWidth(32, 4000);
			row0.getCell(32).setCellValue("Email Id Of Deductee");
			sheet.setColumnWidth(33, 4000);
			row0.getCell(33).setCellValue("Contact Number Of Deductee");
			sheet.setColumnWidth(34, 4000);
			row0.getCell(34).setCellValue("Address Of Deductee in Country of Residence");
			sheet.setColumnWidth(35, 4000);
			row0.getCell(35).setCellValue("Tax Identification Number");
			sheet.setColumnWidth(36, 4000);
			row0.getCell(36).setCellValue("Error Description");
			sheet.setColumnWidth(37, 4000);
			row0.getCell(37).setCellValue("Warning Description");
			sheet.setColumnWidth(38, 4000);
			row0.getCell(38).setCellValue("short deduction");
			sheet.setColumnWidth(39, 4000);
			row0.getCell(39).setCellValue("Interest on Short deduction");
			sheet.setColumnWidth(40, 4000);
			row0.getCell(40).setCellValue("Interest on Late Payment");
			sheet.setColumnWidth(41, 4000);
			row0.getCell(41).setCellValue("Interest on Late Deduction");
			sheet.setColumnWidth(42, 4000);
			row0.getCell(42).setCellValue("Comments");
			sheet.setColumnWidth(43, 4000);
			row0.getCell(43).setCellValue("Status");
	...
	public static void main(String[] args) {
		Form27QDeducteeExcel cde = new Form27QDeducteeExcel();
		cde.initialise("C:\\Users\\RJSA-15022021-03\\Desktop\\Form27QDeductee.xlsx");
		cde.close();
	}
