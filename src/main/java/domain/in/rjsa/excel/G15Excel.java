...
//				row3.getCell(i).setCellStyle(style2);
			...
			row1.getCell(1).setCellValue("FORM 15G");
...
//			row4.getCell(5).setCellValue("");
	...
	private void studentDetailExcel(SXSSFWorkbook wbs2) {
		try {
			Sheet sheet = wbs.createSheet("G15");
			...
			row0.getCell(3).setCellValue("Customer /Vendor Id");
			sheet.setColumnWidth(4, 4000);
			row0.getCell(4).setCellValue("Account No");
			sheet.setColumnWidth(5, 4000);
			row0.getCell(5).setCellValue("Branch Code");
			sheet.setColumnWidth(6, 4000);
			row0.getCell(6).setCellValue("Tan No");
			sheet.setColumnWidth(7, 4000);
			row0.getCell(7).setCellValue("Unique Reference No");
			sheet.setColumnWidth(8, 4000);
			row0.getCell(8).setCellValue("Unique Identification No");
			sheet.setColumnWidth(9, 4000);
			row0.getCell(9).setCellValue("Identification number of relevant investment/account, etc.");
			sheet.setColumnWidth(10, 4000);
			row0.getCell(10).setCellValue("Nature of income");
			sheet.setColumnWidth(11, 4000);
			row0.getCell(11).setCellValue("Section under which tax is deductible");
			sheet.setColumnWidth(12, 4000);
			row0.getCell(12).setCellValue("Amount of income");
			sheet.setColumnWidth(13, 4000);
			row0.getCell(13).setCellValue("Name of Assessee (Declarant)");
			sheet.setColumnWidth(14, 4000);
			row0.getCell(14).setCellValue("PAN of the Assessee");
			sheet.setColumnWidth(15, 4000);
			row0.getCell(15).setCellValue("Aadhaar Number");
			sheet.setColumnWidth(16, 4000);
			row0.getCell(16).setCellValue("Status");
			sheet.setColumnWidth(17, 4000);
			row0.getCell(17).setCellValue("Sub-Status");
			sheet.setColumnWidth(18, 4000);
			row0.getCell(18).setCellValue("Previous year (P.Y.) (for which declaration is being made)");
			sheet.setColumnWidth(19, 4000);
			row0.getCell(19).setCellValue("Residential Status");
			sheet.setColumnWidth(20, 4000);
			row0.getCell(20).setCellValue("Country");
			sheet.setColumnWidth(21, 4000);
			row0.getCell(21).setCellValue("Flat / Door / Building");
			sheet.setColumnWidth(22, 4000);
			row0.getCell(22).setCellValue("Road / Street / Block / Sector");
			sheet.setColumnWidth(23, 4000);
			row0.getCell(23).setCellValue("Pincode");
			sheet.setColumnWidth(24, 4000);
			row0.getCell(24).setCellValue("Post Office");
			sheet.setColumnWidth(25, 4000);
			row0.getCell(25).setCellValue("Area/ Locality");
			sheet.setColumnWidth(26, 4000);
			row0.getCell(26).setCellValue("District");
			sheet.setColumnWidth(27, 4000);
			row0.getCell(27).setCellValue("State");
			sheet.setColumnWidth(28, 4000);
			row0.getCell(28).setCellValue("Email");
			sheet.setColumnWidth(29, 4000);
			row0.getCell(29).setCellValue("Telephone No.");
			sheet.setColumnWidth(30, 4000);
			row0.getCell(30).setCellValue("Mobile No.");
			sheet.setColumnWidth(31, 4000);
			row0.getCell(31).setCellValue("Whether assessed to tax under the Income-tax Act, 1961");
			sheet.setColumnWidth(32, 4000);
			row0.getCell(32).setCellValue("If yes, latest assessment year for which assessed");
			sheet.setColumnWidth(33, 4000);
			row0.getCell(33).setCellValue("Estimated income for which this declaration is made");
			sheet.setColumnWidth(34, 4000);
			row0.getCell(34).setCellValue("Estimated total income of the P.Y. (including income for which this declaration is made)");
			sheet.setColumnWidth(35, 4000);
			row0.getCell(35).setCellValue("Total No. of Form No. 15G filed");
			sheet.setColumnWidth(36, 4000);
			row0.getCell(36).setCellValue("Aggregate amount of income for which Form No.15G filed");
			sheet.setColumnWidth(37, 4000);
			row0.getCell(37).setCellValue("Date on which Declaration is received");
			sheet.setColumnWidth(38, 4000);
			row0.getCell(38).setCellValue("Amount of income paid");
			sheet.setColumnWidth(39, 4000);
			row0.getCell(39).setCellValue("Date on which the income has been paid/credited");
			sheet.setColumnWidth(40, 4000);
			row0.getCell(40).setCellValue("Financial Year");
			sheet.setColumnWidth(41, 4000);
			row0.getCell(41).setCellValue("Warning");
			sheet.setColumnWidth(42, 4000);
			row0.getCell(42).setCellValue("Error");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public static void main(String[] args) {
		G15Excel cde = new G15Excel();
		cde.initialise("C:\\Users\\RJSA-15022021-03\\Desktop\\G15.xlsx");
		cde.close();
	}
