...
//				row3.getCell(i).setCellStyle(style2);
			...
			row1.getCell(1).setCellValue("LOGS");
...
//		stylematchblank();
		try {
			Sheet sheet = wbs.createSheet("logs");
			...
			row0.getCell(1).setCellValue("User Name");
			sheet.setColumnWidth(2, 5000);
			row0.getCell(2).setCellValue("IP Address");
			sheet.setColumnWidth(3, 4000);
			row0.getCell(3).setCellValue("Entity");
			sheet.setColumnWidth(4, 4000);
			row0.getCell(4).setCellValue("Date");
			sheet.setColumnWidth(5, 4000);
			row0.getCell(5).setCellValue("Details");
			sheet.setColumnWidth(6, 4000);
			row0.getCell(6).setCellValue("Action");
	...
	public static void main(String[] args) {
		LogsExcel cde = new LogsExcel();
		cde.initialise("C:\\Users\\RJSA-15022021-03\\Desktop\\Logs.xlsx");
		cde.close();
	}
