...
//				row3.getCell(i).setCellStyle(style2);
			...
			row1.getCell(1).setCellValue("MIS REPORT");
...
//		stylematchblank();
		try {
			Sheet sheet = wbs.createSheet("misReport-1");
			...
			row0.getCell(1).setCellValue("Branch Code");
			sheet.setColumnWidth(2, 5000);
			row0.getCell(2).setCellValue("Financial Year");
			sheet.setColumnWidth(3, 4000);
			row0.getCell(3).setCellValue("from Date");
			sheet.setColumnWidth(4, 4000);
			row0.getCell(4).setCellValue("To Date");
			sheet.setColumnWidth(5, 4000);
			row0.getCell(5).setCellValue("Report Type");
			sheet.setColumnWidth(6, 4000);
			row0.getCell(6).setCellValue("User Name");
	...
	public static void main(String[] args) {
		MisReportExcel cde = new MisReportExcel();
		cde.initialise("C:\\Users\\RJSA-15022021-03\\Desktop\\MisReport.xlsx");
		cde.close();
	}
