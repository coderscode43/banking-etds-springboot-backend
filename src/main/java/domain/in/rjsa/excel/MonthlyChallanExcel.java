...
public class MonthlyChallanExcel {
...
//				row3.getCell(i).setCellStyle(style2);
			...
			row1.getCell(1).setCellValue("MONTHLY CHALLAN");
...
//		stylematchblank();
	...
	public static void main(String[] args) {
		MonthlyChallanExcel cde = new MonthlyChallanExcel();
		cde.initialise("C:\\Users\\RJSA-15022021-03\\Desktop\\MonthlyChallan.xlsx");
		cde.close();
	}
