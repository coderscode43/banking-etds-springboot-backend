...
public class PanUpdateListExcel {
...
//				row3.getCell(i).setCellStyle(style2);
			...
			row1.getCell(1).setCellValue("Pan Update List");
...
//		stylematchblank();
		try {
			...
			row0.getCell(1).setCellValue("FY");
			sheet.setColumnWidth(2, 5000);
			row0.getCell(2).setCellValue("Month");
			sheet.setColumnWidth(3, 4000);
			row0.getCell(3).setCellValue("Challan Heading");
			sheet.setColumnWidth(4, 4000);
			row0.getCell(4).setCellValue("Customer Vendor ID");
			sheet.setColumnWidth(5, 4000);
			row0.getCell(5).setCellValue("Previous Pan");
			sheet.setColumnWidth(6, 4000);
			row0.getCell(6).setCellValue("New Pan");
			sheet.setColumnWidth(7, 4000);
			row0.getCell(7).setCellValue("Remark");
			return sheet;
	} catch (Exception e) {
		e.printStackTrace();
	}
	...
	private void studentDetailExcel(SXSSFWorkbook wbs2) {
		try {
			int part = 1;
			initializeSheet("PanUpdateList-1");
	...
	public static void main(String[] args) {
		PanUpdateListExcel cde = new PanUpdateListExcel();
		cde.initialise("C:\\Users\\RJSA-15022021-03\\Desktop\\PanUpdateList.xlsx");
		cde.close();
	}
