...
//		stylematchblank();
		try {
			...
			sheet.setColumnWidth(2, 5000);
			row0.getCell(2).setCellValue("FORM");
			sheet.setColumnWidth(3, 4000);
			row0.getCell(3).setCellValue("QUARTER");
			sheet.setColumnWidth(4, 4000);
			row0.getCell(4).setCellValue("AS ON DATE");
	...
	public static void main(String[] args) {
		StatementStatusExcel cde = new StatementStatusExcel();
		cde.initialise("C:\\Users\\RJSA-15022021-03\\Desktop\\StatementStatus.xlsx");
		cde.close();
	}
