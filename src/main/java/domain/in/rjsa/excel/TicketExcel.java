...
//				row3.getCell(i).setCellStyle(style2);
			...
			row1.getCell(1).setCellValue("Ticket");
...
//			row4.getCell(5).setCellValue("");
	...
	private void studentDetailExcel(SXSSFWorkbook wbs2) {
		try {
			Sheet sheet = wbs.createSheet("ticket");
			...
			row0.getCell(1).setCellValue("Financial Year");
			sheet.setColumnWidth(2, 5000);
			row0.getCell(2).setCellValue("Quarter");
			sheet.setColumnWidth(3, 4000);
			row0.getCell(3).setCellValue("Branch Code");
	...
	public static void main(String[] args) {
		TicketExcel cde = new TicketExcel();
		cde.initialise("C:\\Users\\RJSA-15022021-03\\Desktop\\Ticket.xlsx");
		cde.close();
	}
