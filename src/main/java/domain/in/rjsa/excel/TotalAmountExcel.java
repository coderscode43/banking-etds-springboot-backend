...
//				row3.getCell(i).setCellStyle(style2);
			...
			row1.getCell(1).setCellValue("Total Amount");
...
//		stylematchblank();
		try {
			...
			row0.getCell(1).setCellValue("Customer ID");
			sheet.setColumnWidth(2, 5000);
			row0.getCell(2).setCellValue("Pan");
			sheet.setColumnWidth(3, 4000);
			row0.getCell(3).setCellValue("Section");
			sheet.setColumnWidth(4, 4000);
			row0.getCell(4).setCellValue("Challan Heading");
			sheet.setColumnWidth(5, 4000);
			row0.getCell(5).setCellValue("Month");
			sheet.setColumnWidth(6, 4000);
			row0.getCell(6).setCellValue("FY");
			sheet.setColumnWidth(7, 4000);
			row0.getCell(7).setCellValue("System Amount");
			sheet.setColumnWidth(8, 4000);
			row0.getCell(8).setCellValue("Traces Amount");
			sheet.setColumnWidth(9, 4000);
			row0.getCell(9).setCellValue("System Amount Tax");
			sheet.setColumnWidth(10, 4000);
			row0.getCell(10).setCellValue("Traces Amount Tax");
			sheet.setColumnWidth(11, 4000);
			row0.getCell(11).setCellValue("Remark");
			sheet.setColumnWidth(12, 4000);
			row0.getCell(12).setCellValue("Source");
	...
	public static void main(String[] args) {
		TotalAmountExcel cde = new TotalAmountExcel();
		cde.initialise("C:\\Users\\RJSA-15022021-03\\Desktop\\TotalAmount.xlsx");
		cde.close();
	}
