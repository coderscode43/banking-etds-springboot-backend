...
public class UploadCertificateExcel {
...
//				row3.getCell(i).setCellStyle(style2);
			...
			row1.getCell(1).setCellValue("Upload Certificate");
...
//		stylematchblank();
	...
	private void studentDetailExcel(SXSSFWorkbook wbs2) {
		try {
			initializeSheet("UploadCertificate-1");
	...
	public static void main(String[] args) {
		UploadCertificateExcel cde = new UploadCertificateExcel();
		cde.initialise("C:\\Users\\RJSA-15022021-03\\Desktop\\UploadCertificate.xlsx");
		cde.close();
	}
