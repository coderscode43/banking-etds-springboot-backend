...
import domain.in.rjsa.model.FileDetail;
import domain.in.rjsa.util.StaticData;

@Transactional
public abstract class AbstractDeclarationService<K extends Serializable, E, D extends DaoInterface<K, E>>
		implements DeclarationServiceInterface<K, E> {
	@Autowired
	FileDetailDao fDao;
	@Override
	...
	@Override
	public void deleteT(K key,Long fileId) {
		if(fileId!=null) {
			fDao.deleteByKey(fileId);
