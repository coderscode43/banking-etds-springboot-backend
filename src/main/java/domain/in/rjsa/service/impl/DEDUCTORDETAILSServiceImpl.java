...
public class DEDUCTORDETAILSServiceImpl extends AbstractServiceTaxo<Long, DEDUCTORDETAILS, DEDUCTORDETAILSDao>
		implements DEDUCTORDETAILSService {
	@Autowired
	...
	public void addData(String json) {
		try {
			...
			for (Object object : jsonArray) {
				...
				DEDUCTORDETAILS dd = new DEDUCTORDETAILS();
				dd.setdata(dataObject);
				dao.persist(dd);
			}
		} catch (Exception e) {
			e.printStackTrace();
