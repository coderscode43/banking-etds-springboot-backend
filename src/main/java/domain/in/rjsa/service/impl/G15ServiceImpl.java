...
implements G15Service {
	...
	public String createUserExcel(LinkedHashMap<String, Object> map) {
		...
		for (G15 g15 : listUsers) {
			...
			if (g15.getCustVendId() == null) {
				details.createCell(3).setCellValue(" ");
			} else {
				details.createCell(3).setCellValue(g15.getCustVendId());
			}
			if (g15.getAccNo() == null) {
				details.createCell(4).setCellValue(" ");
			} else {
				details.createCell(4).setCellValue(g15.getAccNo());
			}
			if (g15.getBranchCode() == null) {
				details.createCell(5).setCellValue(" ");
			} else {
				details.createCell(5).setCellValue(g15.getBranchCode());
			}
			if (g15.getTan() == null) {
				details.createCell(6).setCellValue(" ");
			} else {
				details.createCell(6).setCellValue(g15.getTan());
			}
			if (g15.getUniqueRefNo() == null) {
				details.createCell(7).setCellValue(" ");
			} else {
				details.createCell(7).setCellValue(g15.getUniqueRefNo());
			}
			if (g15.getUniqueIdentificationNo() == null) {
				details.createCell(8).setCellValue(" ");
			} else {
				details.createCell(8).setCellValue(g15.getUniqueIdentificationNo());
			}
			if (g15.getIdentificationNumberofRelevantInvestmentAccount() == null) {
				details.createCell(9).setCellValue(" ");
			} else {
				details.createCell(9).setCellValue(g15.getIdentificationNumberofRelevantInvestmentAccount());
			}
			if (g15.getNatureofIncome() == null) {
				details.createCell(10).setCellValue(" ");
			} else {
				details.createCell(10).setCellValue(g15.getNatureofIncome());
			}
			if (g15.getSectionUnderWhichTaxisDeductible() == null) {
				details.createCell(11).setCellValue(" ");
			} else {
				details.createCell(11).setCellValue(g15.getSectionUnderWhichTaxisDeductible());
			}
